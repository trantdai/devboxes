...
# um install -y python36 python36-pip
# ython3.6 -V
# ython3.6 -m pip install 'pylint==2.6.0' 'coverage==5.2.1' 'twine==3.2.0' --trusted-host pypi.python.org
# ython3.6 -m pip install 'paramiko==2.6.0' --trusted-host pypi.python.org
yum install -y vim
yum install -y nano
yum install -y tree
yum install -y git
